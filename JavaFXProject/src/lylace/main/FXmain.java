...
public class FXmain extends Application {
	// JavaFX 응용프로그램 개발시 Application 추상클래스 상속
	...
	public void start(Stage pStage) throws Exception {
		...
		pStage.getIcons().add(new Image("/lylace/icon/piggy-bank.png"));
		// 아이콘 표시

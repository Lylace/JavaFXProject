...
import lylace.model.SungJukModel;
...
public class Lab01Controller 
	...
	public void addSungJuk(ActionEvent ae) {
	  try {
		SungJukModel sj = new SungJukModel(
			name.getText(), kor.getText(),
			eng.getText(), mat.getText() );
		sjlist.add(sj);
	...
	public void modifySungJuk(ActionEvent ae) {
		int num = sjtable.getSelectionModel()
				.getSelectedIndex();
		// 수정할 행의 순번index을 알아냄
		SungJukModel sj = new SungJukModel(
			name.getText(), kor.getText(),
	...
	public void clickSungJuk(MouseEvent me) {
		...
		if (me.getClickCount() == 2) {
			...
			SungJukModel sj = (SungJukModel)
				sjtable.getSelectionModel()
				.getSelectedItem();
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		sjname.setCellValueFactory(
			new PropertyValueFactory
			         <SungJukModel, String>("name"));
		sjkor.setCellValueFactory(
				new PropertyValueFactory
				         <SungJukModel, String>("kor"));
		sjeng.setCellValueFactory(
				new PropertyValueFactory
				         <SungJukModel, String>("eng"));
		sjmat.setCellValueFactory(
				new PropertyValueFactory
				         <SungJukModel, String>("mat"));
		sjtot.setCellValueFactory(
				new PropertyValueFactory
				         <SungJukModel, String>("tot"));
		sjavg.setCellValueFactory(
				new PropertyValueFactory
				         <SungJukModel, String>("avg"));
		sjgrd.setCellValueFactory(
				new PropertyValueFactory
				         <SungJukModel, String>("grd")); 
